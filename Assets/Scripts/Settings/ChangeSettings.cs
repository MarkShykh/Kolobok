...
public class ChangeSettings : MonoBehaviour
{
    ...
    public void ToggleSound()
    {
        ...
        FindObjectOfType<SoundMixerManager>().SetSoundFXEnabled(PlayerPrefs.GetInt("Sound") == 1);
        DisplaySettings();
    }
    ...
    public void ToggleMusic()
    {
        ...
        FindObjectOfType<SoundMixerManager>().SetMusicEnabled(PlayerPrefs.GetInt("Music") == 1);
